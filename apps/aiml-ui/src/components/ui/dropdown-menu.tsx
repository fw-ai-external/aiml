    ...
    <DropdownMenuPrimitive.Portal container={container}>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "popover-backdrop-filter bg-aiml-bg-2 popover-border popover-shadow popover-foreground data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 min-w-[8rem] overflow-auto overflow-x-hidden rounded-md p-1",
          className
        )}
        {...props}
      />
...
type VirtualizedDropdownItemsProps<T> =
...
function VirtualizedDropdownItems<T>({
  itemsCount,
  items,
  renderItem,
  ...props
}: VirtualizedDropdownItemsProps<T>) {
