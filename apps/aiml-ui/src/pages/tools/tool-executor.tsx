...
const ToolExecutor = ({
  ...
  return (
    <div className="w-full h-full grid grid-cols-[300px_1fr] p-2 gap-2">
      <div className="flex flex-col gap-4 border-[0.5px] border-aiml-border-1 rounded-[0.25rem] bg-aiml-bg-2 p-4 py-6">
      ...
      <div className="flex relative group flex-col gap-4 border-[0.5px] border-aiml-border-1 rounded-[0.25rem] bg-aiml-bg-2 p-4 py-6">
        <Text variant="secondary" className="text-aiml-el-3  px-4" size="xs">
          Output
        </Text>
