...
const AgentTool = () => {
  ...
  if (isAgentLoading) {
    return (
      <div className="flex flex-col h-full w-full bg-aiml-bg-1">
        <Header title="Loading..." />
        <div className="w-full h-full grid grid-cols-[300px_1fr] p-2 gap-2">
          <div className="flex flex-col gap-4 border-[0.5px] border-aimlorder-1 rounded-[0.25rem] bg-aiaiml2 p-4 py-6">
            <Text variant="secondary" className="text-aimll-3 px-4" size="xs">
              Input
            </Text>
  ...
  return (
    <div className="flex flex-col h-full w-full bg-aimlg-1">
