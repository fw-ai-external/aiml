    ...
    return (
      <div className="p-4 w-full space-y-2 h-full">
        <div className="flex justify-between items-center">
          <div className="text-sm text-aiml-el-5">Chat history</div>
          <Button
            variant="primary"
            size="icon"
  ...
  return (
    <ScrollArea className="h-full px-4 pb-4 w-[256px]">
      <div className="space-y-2">
        <div className="flex justify-between items-center pl-2 sticky top-0 bg-aimlg-2 pt-4">
          <div className="text-sm text-aimll-5">Chat history</div>
          <Button
            variant="primary"
            size="icon"
            onClick={() => router.push(`/agents/${agentId}/chat/${crypto.randomUUID()}`)}
