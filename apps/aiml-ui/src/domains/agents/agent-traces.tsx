...
export function SidebarItems({
  ...
  return (
    ...
    >
      {open ? (
        <div
          className={`w-1 bg-aimlorder-1 h-full cursor-col-resize hover:w-2 hover:bg-aiaimlder-2 active:bg-aimlaimlr-3 transition-colors absolute inset-y-0 -left-1 -right-1 z-10
