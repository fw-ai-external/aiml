        ...
        <div className="w-full h-full grid grid-cols-[300px_1fr] py-6 px-4">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <div className="px-2 py-2 rounded-md bg-aiml-bg-13 mb-2">
          ...
          <div className="border-l border-aiml-border-1 pl-4">
      ...
      <div className="w-full h-full grid grid-cols-[300px_1fr]  ">
            ...
            {Object.keys(tools).length > 0 && (
              ...
              >
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-sm text-aiml-el-6">All Tools</p>
                </div>
              </li>
            )}
            {Object.entries(agents).map(([key, agent]) => (
              ...
              >
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-sm text-aiml-el-6">{agent.name} Tools</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="flex flex-col gap-4 py-6 px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
            {isLoadingAgent ? (
              <>
                <div className="flex flex-col gap-[0.62rem] bg-aiml-bg-13 px-[0.62rem] py-2 rounded-[0.375rem] border-[0.5px] border-aiml-border-1">
                  <Skeleton className="h-4 w-24" />
