...
export default function AgentChat({
  ...
  React.useEffect(() => {
    if (memory?.result && !threadId) {
      router.push(`/agents/${resolvedParams.agentId}/chat/${crypto.randomUUID()}`);
    }
  ...
  return (
    ...
    >
      {sidebar && memory?.result ? <AgentSidebar agentId={resolvedParams.agentId} threadId={threadId!} /> : null}
