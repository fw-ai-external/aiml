...
export const AgentSpecificationVersionTable = pgTable('agent_specification_version', {
  id: serial('id').primaryKey(),
...
export const agentSpecificationVersionRelations = relations(AgentSpecificationVersionTable, ({ one }) => ({
...
export const AgentSpecificationVersion = createSelectSchema(AgentSpecificationVersionTable, {
  createdAt: z.coerce.date(),
});

export const NewAgentSpecificationVersion = createInsertSchema(AgentSpecificationVersionTable).omit({
  id: true,
  createdAt: true,
});
...
export type AgentSpecificationVersion = z.infer<typeof AgentSpecificationVersion>;
export type NewAgentSpecificationVersion = z.infer<typeof NewAgentSpecificationVersion>;
