// Copied from https://github.com/statelyai/xstate/blob/main/packages/core/src/scxml.ts with minimum reference changes.
...
function mapValues<P, O extends Record<string, unknown>>(
  collection: O,
