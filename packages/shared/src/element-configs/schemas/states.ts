...
export const stateConfig: BaseElementDefinition = {
  ...
  documentation: 'A standard state in the state machine, can contain child states to form a compound state',
};
...
export const parallelConfig: BaseElementDefinition = {
  ...
  documentation: 'Enables parallel execution of multiple states, used for concurrent state machines',
};
...
export const finalConfig: BaseElementDefinition = {
  ...
  documentation: 'A terminal state indicating the completion of a region in the state machine',
};
