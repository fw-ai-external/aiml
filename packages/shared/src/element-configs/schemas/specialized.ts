import { z } from 'zod';
import { type AllowedChildrenType, type BaseElementDefinition, ValueType } from '../../types';
...
export const dataConfig: BaseElementDefinition = {
  ...
  propsSchema: z.object({
    ...
    type: z.enum([ValueType.STRING, ValueType.NUMBER, ValueType.BOOLEAN, ValueType.JSON]).default(ValueType.STRING),
  ...
  allowedChildren: 'text' as AllowedChildrenType,
  documentation: 'Declares a data model variable with optional initial value and type',
};
