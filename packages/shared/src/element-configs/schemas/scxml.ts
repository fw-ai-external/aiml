...
export const initialConfig: ElementDefinition = {
  ...
  documentation: 'The initial element represents the default initial state for a state machine or compound state.',
};
...
export const historyConfig: ElementDefinition = {
  ...
  documentation: 'The history element represents a pseudo-state that remembers the last active state configuration.',
};

// Schema for donedata element
export const donedataConfig: ElementDefinition = {
  tag: 'donedata',
  elementType: 'donedata',
  role: 'action',
  allowedChildren: ['content', 'param'],
  propsSchema: z.object({}) as z.ZodObject<any>,
  description: 'Specifies the data to be returned when a state machine reaches its final state',
  documentation: 'The donedata element is used to return data when a <final> state is entered.',
};
...
export const contentConfig: ElementDefinition = {
  ...
  documentation: 'The content element defines the content that is returned when a state machine completes.',
};
...
export const paramConfig: ElementDefinition = {
  ...
  documentation: 'The param element defines a parameter to be passed to an invoked service.',
};
...
export const invokeConfig: ElementDefinition = {
  ...
  documentation: 'The invoke element is used to create an instance of an external service.',
};

// Schema for finalize element
export const finalizeConfig: ElementDefinition = {
  tag: 'finalize',
  elementType: 'finalize',
  role: 'action',
  allowedChildren: ['script', 'assign', 'raise', 'if', 'foreach', 'log'],
  propsSchema: z.object({}) as z.ZodObject<any>,
  description: 'Contains executable content to be executed when the invoked process returns',
  documentation: 'The finalize element defines actions to be executed when an invoked service returns data.',
};
