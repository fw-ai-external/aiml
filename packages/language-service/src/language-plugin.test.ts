...
test("create virtual code w/ mdxjsEsm", () => {
  ...
  expect(code!.embeddedCodes.length).toBe(2);
  expect(code!.embeddedCodes[0].id).toBe("jsx");
  expect(code!.embeddedCodes[0].languageId).toBe("javascriptreact");
  expect(code!.embeddedCodes[0].mappings.length).toBe(1);
  expect(code!.embeddedCodes[0].mappings[0].data).toEqual({
    completion: true,
    format: true,
    navigation: true,
    semantic: true,
  ...
  expect(code!.embeddedCodes[1].id).toBe("md");
  expect(code!.embeddedCodes[1].languageId).toBe("markdown");
});
...
test("create virtual code w/ dedented markdown content", () => {
  ...
  expect(code!.embeddedCodes[1].id).toBe("md");
  expect(code!.embeddedCodes[1].languageId).toBe("markdown");
  expect(code!.embeddedCodes[1].mappings.length).toBe(1);
  expect(code!.embeddedCodes[1].mappings[0].data).toEqual({
    completion: true,
    format: false,
    navigation: true,
    semantic: true,
