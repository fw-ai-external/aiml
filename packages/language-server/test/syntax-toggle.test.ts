...
test('delete', async () => {
  ...
  const result = await serverHandle.sendExecuteCommandRequest('mdx.toggleDelete', [
    'memory://1',
    /** @satisfies {Range} */
...
test('emphasis', async () => {
  ...
  const result = await serverHandle.sendExecuteCommandRequest('mdx.toggleEmphasis', [
    'memory://1',
    /** @satisfies {Range} */
    { end: { character: 3, line: 0 }, start: { character: 3, line: 0 } },
  ]);
...
test('inlineCode', async () => {
  ...
  const result = await serverHandle.sendExecuteCommandRequest('mdx.toggleInlineCode', [
    'memory://1',
    /** @satisfies {Range} */
    { end: { character: 3, line: 0 }, start: { character: 3, line: 0 } },
  ]);
...
test('strong', async () => {
  ...
  const result = await serverHandle.sendExecuteCommandRequest('mdx.toggleStrong', [
    'memory://1',
    /** @satisfies {Range} */
    { end: { character: 3, line: 0 }, start: { character: 3, line: 0 } },
  ]);
